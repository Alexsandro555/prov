...
class CreateAttributeUnitsTable extends Migration
{
  private $tableName = 'attribute_units';
  ...
  public function up()
  {
    ...
    DB::statement("ALTER TABLE `$this->tableName` comment 'Еденицы измерения атрибута'");
  }
