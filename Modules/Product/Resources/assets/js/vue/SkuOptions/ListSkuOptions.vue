                        ...
                        <v-data-table :headers="headers"
                            ...
                            <template slot="items" slot-scope="props">
                                ...
                                <td class="justify-center layout px-0">
                                    ...
                                    <v-btn icon class="mx-0" @click="$router.push('/skuoptions/edit/'+props.item.id)">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('SkuOptions', ['items', 'loading']),
        },
        methods: {
            addSkuOptions() {
                /*this.add()
            ...
            ...mapActions('SkuOptions',{load: GLOBAL.LOAD, add: GLOBAL.ADD, delete: GLOBAL.DELETE, initialization: GLOBAL.INITIALIZATION})
        }
     }
</script>