...
class InitializerServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'initializer'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/initializer');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/initializer';
        }, \Config::get('view.paths')), [$sourcePath]), 'initializer');
    }
    ...
    {
        $langPath = resource_path('lang/modules/initializer');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'initializer');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'initializer');
        }
    }
