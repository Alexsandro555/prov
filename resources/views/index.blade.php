      ...
      <v-flex class="content__info" xs12>
        ...
        <!--<v-flex offset-xs3 xs6 class="hidden-md-and-down">
          ...
          <v-flex offset-md3 xs8 md6>
            <p class="content__header text-sm-left">Рекомендуемые <span class="content__subheader hidden-sm-and-down">товары</span>
            </p>
            <div class="banner"></div>
          </v-flex>
          ...
          <v-flex class="text-md-center" offset-md3 offset-xs1 lg9 md8 sm9 xs10>
            <leader-slider :perpage=3 url="/products/special"
                           :per-custom="[[200, 1], [480, 1], [720, 2], [960, 2], [1280, 3]]">
              @include('product')
            </leader-slider>
          </v-flex>
        </v-layout>
            ...
            <v-flex xs12>
              <v-layout row wrap>
                ...
                <v-flex class="text-xs-left about__main-info" xs10 sm10 md6>
                  <p class="about__header text-md-left">О компании <span class="content__subheader hidden-sm-and-down">и оборудовании</span>
                  </p>
                ...
                <v-flex xs3 class="hidden-md-and-down">
                  <p class="about__header text-md-left low-font">Внимание! <span class="content__subheader">акция</span>
                  </p>
            ...
            <v-flex xs12 sm12 md6 lg6 xl6>
              <v-layout row wrap>
                ...
                <v-flex xs5 sm4 xl4 class="text-md-right hidden-sm-and-down">
                  <a class="delivery__button" href="/sale">В каталог
                    <v-icon color="green darken-2" medium>keyboard_arrow_right</v-icon>
                  </a>
                </v-flex>
                <v-flex xs10 sm6 md10 lg12 class="text-xs-left">
                  <leader-slider :perpage=2 url="/products/new"
                                 :per-custom="[[200, 1], [480, 1], [720, 2], [960, 2], [1280, 3]]">
                </v-flex>
              </v-layout>
            </v-flex>
            <v-flex class="delivery__left" xs12 sm12 md4 lg6 xl6>
              <v-layout row wrap>
                ...
                <v-flex pa-2 xs12 sm12 md10 lg10 xl10>
                  <p class="delivery__header text-xs-left">Доставка и <span class="delivery__subheader">оплата</span>
                  </p>
                </v-flex>
                <v-flex pa-2 xs12 sm12 md8 lg12 xl12 class="delivery__desc text-xs-left text-xs-left text-md-left">
                  ...
                  <p>
                    Также продукцию можно забрать самовывозом с нашего склада<br> в <a href="/delivery"
                                                                                       style="color: green; text-decoration: none; text-align: bold;">г.
